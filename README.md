# Atalasoft WingScan Acquisition demo
A ASP.Net Demo application written in C# demonstrating the WebScanning component - shows browser based scanning and viewing in the WebDocumentViewer  WebCapture API Reference
