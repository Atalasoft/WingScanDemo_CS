...
function ToggleVRSState() {
    ...
    if (Atalasoft.Controls.Capture.WebScanning.scanningOptions.applyVRS) {
        $('.atala-VRS-button').css("background-image", "url('icons/vrs16.png')");
        $('.atala-VRS-button').attr("title", "VRS Enabled");
    }
    else {
        $('.atala-VRS-button').css("background-image", "url('icons/novrs16.png')");
...
function scanErrorHandler(msg, params) {
    ...
    switch (msg) {
        ...
        case Atalasoft.Controls.Capture.Errors.activeX:
            ...
            "or enabled.  When prompted, please allow the WingScan Web <br/>" +
        ...
        case Atalasoft.Controls.Capture.Errors.noPlugin:
            promptHTML(
                ...
                "Please follow any prompts to install it, or <a href='WebCapture/" + params.filename + "'>Click Here</a><br />" +
        ...
        case Atalasoft.Controls.Capture.Errors.oldPlugin:
            promptHTML(
                ...
                "<a href='WebCapture/" + params.filename + "'>Click Here</a><br />" +
                "Refresh your browser when completed.");
            break;
